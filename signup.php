...
//$exists=false;
// $existsql="SELECT * FROM 'users' WHERE EnrollmentNumber='$EnrollmentNumber'";
...
$sql="INSERT INTO `users` (`Firstname`, `Lastname`, `EnrollmentNumber`, `dob`, `City`, `ZIP`, `State`, `PhoneNumber`, `Emailadress`, `password`, `cpassword`) VALUES ('$Firstname', '$Lastname', '$EnrollmentNumber', '$dob', '$City', '$ZIP', '$State','$PhoneNumber', '$Emailadress', '$password', '$cpassword')";
...
?>
  ...
  <div class="row ">
    <div class="col ">
    <label for="inputAddress">Enrollment Number</label>
    <input type="text" required  class="form-control" name="EnrollmentNumber" id="inputAddress">
    </div>
    <div class="col mb-3" >
  ...
  <div class="form-group mb-3">
      ...
      <select id="inputState" required class="form-control" name="State">
        ...
        <option value="Arunachal	Pradesh	">			Uttarakhand		</option>
        <option value="Arunachal	Pradesh	">				West Bengal>	</option>
</option>
      </select>
    </div>
    </div>
